...
namespace NFL.DAO.Migrations
{
    ...
    [Migration("20230517114354_AddedEntityPlayerInTeam")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Tables.MatchTicket", b =>
                {
            ...
            modelBuilder.Entity("Entities.Tables.PlayerInTeam", b =>
                {
                    b.Property<int>("PlayerInTeamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlayerInTeamId"), 1L, 1);

                    b.Property<int>("PlayerJerseyNumber")
                        .HasColumnType("int");
                    ...
                    b.HasAlternateKey("TeamAbbreviation", "PlayerJerseyNumber");

                    b.ToTable("TeamDepthCharts", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.Views.LastPlayedMatchId", b =>
                {
                    b.Property<int?>("MatchId")
                        .HasColumnType("int");
                    ...
                    b.ToView("IdForLastPlayedMatchForEveryTeam");
                });
            ...
            modelBuilder.Entity("Entities.Tables.MatchTicket", b =>
                {
                    ...
                    b.HasOne("Entities.Tables.User", "User")
                        .WithMany("Bookings")
